...
static yyconst flex_int16_t yy_base[23] =
    {   0,
        0,    0,   20,   21,   21,   16,   21,   21,   21,    9,
       21,    6,   21,   21,    0,   21,    8,    7,    0,    0,
       21,   12
    } ;
...
YY_RULE_SETUP
#line 34 "expr.l"
{ yylval.id = get_symbol(symbol_table, yytext); return ID; }
	YY_BREAK
case 10:
