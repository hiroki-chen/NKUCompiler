...
typedef class Item_func_call_list final : public Item_expr {
 ...
 public:
  ...
  virtual std::vector<Item_expr*> get_arguments(void) const {
    return arguments;
  }
...
typedef class Item_func_call final : public Item_expr {
 ...
 public:
  virtual Item_expr::expr_type get_expr_type(void) const override {
    return Item_expr::expr_type::FUNC_CALL_TYPE;
  }
  ...
  Item_func_call(const uint32_t& lineno, Item_ident* const identifier,
                 Item_func_call_list* const arguments);
...
typedef class Item_func_def_arg final : public Item_expr {
 ...
 public:
  virtual Item_expr::expr_type get_expr_type(void) const override {
    return Item_expr::expr_type::FUNC_DEF_ARG_TYPE;
  }
  ...
  Item_func_def_arg(const uint32_t& lineno, const basic_type& type,
                    Item_ident* const identifier);
...
typedef class Item_func_def_list final : public Item_expr {
 ...
 public:
  ...
  virtual size_t get_arg_number(void) const { return arguments.size(); }

  virtual std::vector<Item_func_def_arg*> get_arguments(void) const {
    return arguments;
  }
...
typedef class Item_func_def final : public Item {
 ...
 public:
  virtual Item::type get_type(void) const override {
    return Item::type::FUNC_DEF_ITEM;
  }

  Item_func_def() = delete;

  Item_func_def(const uint32_t& lineno, const basic_type& return_type,
                Item_ident* const identifier,
                Item_func_def_list* const parameter,
                Item_block* const func_body);
