 ...
 *
 * @note YOU MUST NOT CREATE A DIRECT INSTANCE FROM ANY ABSTRACT CLASS AS THIS
 * MEANS NOTHING.
 *
 */
typedef class Item {
 ...
 public:
   ...
   *
   * Basically, there is a super node called <b>Program</b> node, which is
   * defined as a root node of the whole AST. Expr, Decl, and Func_def are
   * derived from the compiler::Item_root node.
   *
   */
  typedef enum type {
    ROOT_ITEM,
   ...
   * @note This function will invoke all of its children's print_result(indent +
